...
library FixedDataPart2 {
    ...
    function southTop() public pure returns (string memory) {
        return
            string(
                abi.encodePacked(
                    '<text style="font-size:14px;fill:#FBBF24;font-family:Arial;font-weight:800" text-anchor="end" x="421" y="592">South</text>',
                    '<text style="font-size:14px;fill:white;font-family:Arial;font-weight:800" x="72" y="592">Round 1</text>',
                    '<rect x="72" y="601" width="349" height="166" rx="8" fill="#202738" fill-opacity="0.34" />',
                    '<text style="font-size:14px;fill:white;font-family:Arial;font-weight:800" x="72" y="801">Round 2</text>',
                    '<rect x="72" y="810" width="349" height="87" rx="8" fill="#202738" fill-opacity="0.34" />',
                    '<text style="font-size:14px;fill:white;font-family:Arial;font-weight:800" x="72" y="931">Round 3</text>',
                    '<rect x="72" y="940" width="349" height="47.5" rx="8" fill="#202738" fill-opacity="0.34" />'
                )
            );
    }
    ...
    function midwestTop() public pure returns (string memory) {
        return
            string(
                abi.encodePacked(
                    '<text style="font-size:14px;fill:#FBBF24;font-family:Arial;font-weight:800" text-anchor="end" x="778" y="592">Midwest</text>',
                    '<text style="font-size:14px;fill:white;font-family:Arial;font-weight:800" x="429" y="592">Round 1</text>',
                    '<rect x="429" y="601" width="349" height="166" rx="8" fill="#202738" fill-opacity="0.34" />',
                    '<text style="font-size:14px;fill:white;font-family:Arial;font-weight:800" x="429" y="801">Round 2</text>',
                    '<rect x="429" y="810" width="349" height="87" rx="8" fill="#202738" fill-opacity="0.34" />',
                    '<text style="font-size:14px;fill:white;font-family:Arial;font-weight:800" x="429" y="931">Round 3</text>',
                    '<rect x="429" y="940" width="349" height="47.5" rx="8" fill="#202738" fill-opacity="0.34" />'
                )
            );
    }
    ...
    function finalFourTop() public pure returns (string memory) {
        return
            string(
                abi.encodePacked(
                    '<text style="font-size:14px;fill:#FBBF24;font-family:Arial;font-weight:800" x="72" y="1011">Final Four</text>',
                    '<rect x="72" y="1021.5" width="349" height="47.5" rx="8" fill="#202738" fill-opacity="0.34" />',
                    '<text style="font-size:14px;fill:#FBBF24;font-family:Arial;font-weight:800" x="429" y="1011">Final Four</text>',
                    '<rect x="429" y="1021.5" width="349" height="47.5" rx="8" fill="#202738" fill-opacity="0.34" />'
                )
            );
    }
