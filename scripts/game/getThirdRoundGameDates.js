 ...
 * - prints the dates of the third round games in chronological order
 *
 * Regions:
...
async function main() {
  ...
  try {
    ...
    const southBracket = thirdRoundBrackets[0];
    const midwestBracket = thirdRoundBrackets[1];
    const eastBracket = thirdRoundBrackets[2];
    const westBracket = thirdRoundBrackets[3];
